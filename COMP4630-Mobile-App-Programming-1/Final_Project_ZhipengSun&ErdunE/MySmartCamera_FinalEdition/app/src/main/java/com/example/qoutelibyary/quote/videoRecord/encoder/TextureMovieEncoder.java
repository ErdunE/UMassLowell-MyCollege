package com.example.qoutelibyary.quote.videoRecord.encoder;
...
import com.example.qoutelibyary.quote.videoRecord.encoder.gles.EglCore;
...
import com.example.qoutelibyary.quote.videoRecord.filters.gpuFilters.baseFilter.MagicCameraInputFilter;
...
//            type = MagicFilterType.NONE;
        ...
        private BaseFilter mShowFilter=new NoneFilter(MyApp.getContext().getResources());
