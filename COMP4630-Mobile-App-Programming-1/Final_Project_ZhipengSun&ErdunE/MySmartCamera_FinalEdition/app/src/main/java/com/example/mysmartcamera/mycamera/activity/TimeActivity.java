...
import com.example.mysmartcamera.mycamera.adapter.Adapter;
...
import com.example.mysmartcamera.mycamera.views.MyTimeView;
...
import static com.example.mysmartcamera.mycamera.utils.StaticFinalValues.COMR_FROM_SEL_COVER_TIME_ACTIVITY;
...
public class TimeActivity extends AppCompatActivity {
    ...
    public Adapter mSelCoverAdapter;
    ...
    private void initListener() {
        mThumbSelTimeView.setOnScrollBorderListener(new MyTimeView.OnScrollBorderListener() {
            @Override
    ...
    private void initSetParam() {
        ...
        if(mVideoRotation.equals("0") && mVideoWidth > mVideoHeight) {
    ...
    private void initView() {
        mSelCoverAdapter = new Adapter(this);
    ...
    private static class MyHandler extends Handler {
        private WeakReference<TimeActivity> mActivityWeakReference;

        public MyHandler(TimeActivity activityWeakReference) {
            mActivityWeakReference = new WeakReference<TimeActivity>(activityWeakReference);
        }

        @Override
        public void handleMessage(Message msg) {
            TimeActivity activity = mActivityWeakReference.get();
            if (activity != null) {
                switch (msg.what) {
                    case SEL_TIME:
