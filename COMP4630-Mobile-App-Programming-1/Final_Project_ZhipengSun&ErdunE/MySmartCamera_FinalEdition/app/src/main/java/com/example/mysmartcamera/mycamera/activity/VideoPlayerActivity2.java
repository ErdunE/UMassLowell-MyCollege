...
import com.example.qoutelibyary.quote.videoPlayer.JZVideoPlayer;
import com.example.qoutelibyary.quote.videoPlayer.PublicVideoJZVideo;
...
import static com.example.mysmartcamera.mycamera.utils.StaticFinalValues.COMR_FROM_VIDEO_EDIT_TIME_ACTIVITY;
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.video_player2_edit_video_tv:
                Intent intent = new Intent(MyApp.getContext(), VideoEditActivity.class);
            ...
            case R.id.video_player2_sel_cover:
                Intent intent2 = new Intent(VideoPlayerActivity2.this, TimeActivity.class);
