package com.example.qoutelibyary.quote.videoRecord.filters.gpuFilters.utils;
...
public class OpenGlUtils {
	...
	public static String readShaderFromRawResource(final int resourceId){
		final InputStream inputStream = MyApp.getContext().getResources().openRawResource(
				resourceId);
