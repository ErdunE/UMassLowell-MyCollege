...
import com.example.qoutelibyary.quote.videoSelect.beans.AudioFile;
import com.example.qoutelibyary.quote.videoSelect.beans.ImageFile;
import com.example.qoutelibyary.quote.videoSelect.beans.NormalFile;
import com.example.qoutelibyary.quote.videoSelect.beans.VideoFile;
import com.example.qoutelibyary.quote.videoSelect.callback.FileLoaderCallbacks;
import com.example.qoutelibyary.quote.videoSelect.callback.FilterResultCallback;

import static com.example.qoutelibyary.quote.videoSelect.callback.FileLoaderCallbacks.TYPE_AUDIO;
import static com.example.qoutelibyary.quote.videoSelect.callback.FileLoaderCallbacks.TYPE_FILE;
import static com.example.qoutelibyary.quote.videoSelect.callback.FileLoaderCallbacks.TYPE_IMAGE;
import static com.example.qoutelibyary.quote.videoSelect.callback.FileLoaderCallbacks.TYPE_VIDEO;
