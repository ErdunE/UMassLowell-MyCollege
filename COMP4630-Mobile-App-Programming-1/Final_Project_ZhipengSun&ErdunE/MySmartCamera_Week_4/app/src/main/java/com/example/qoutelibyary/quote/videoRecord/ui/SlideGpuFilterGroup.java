package com.example.qoutelibyary.quote.videoRecord.ui;
...
import com.example.qoutelibyary.quote.videoRecord.other.MagicFilterFactory;
...
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(MyApp.getContext());
    }
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                locked = true;
                downX = -1;
                if (offset > MyApp.screenWidth / 3) {
                    scroller.startScroll(offset, 0, MyApp.screenWidth - offset, 0, 100 * (1 - offset / MyApp.screenWidth));
                    needSwitch = true;
                } else {
                    scroller.startScroll(offset, 0, -offset, 0, 100 * (offset / MyApp.screenWidth));
                    needSwitch = false;
                }
                break;
        }
