package com.example.mysmartcamera.mycamera.popwindow;
...
import com.example.qoutelibyary.quote.videoRecord.ui.ThumbnailCountDownTimeView;
...
public class PopupManager {
    ...
    public void showCountDown(Resources res, int mStartTime, final SelTimeBackListener pop) {
        ...
        int min = mStartTime * (MyApp.screenWidth - (int) res.getDimension(R.dimen.dp20)) / 30;
        selTimeTv.layout(min, 0, selTimeTv.getHeight(), selTimeTv.getWidth());
        selTimeTv.setTranslationX((MyApp.screenWidth - (int) res.getDimension(R.dimen.dp40)));
