...
import com.example.mysmartcamera.adapter.ThumbAdapter;
...
import com.example.mysmartcamera.views.ThumbnailView;
import com.example.mysmartcamera.views.VideoPreviewView;
...
import static com.example.mysmartcamera.StaticFinalValues.ISSAVEVIDEOTEMPEXIST;
import static com.example.mysmartcamera.StaticFinalValues.VIDEOTEMP;
...
public class LocalVideoActivity extends AppCompatActivity implements MediaPlayerWrapper.IMediaCallback {
    ...
    private void initListener() {
        ...
        mLocalThumbView.setOnScrollBorderListener(new ThumbnailView.OnScrollBorderListener() {
            ...
            public void OnScrollBorder(float start, float end) {
                ...
                mStartTime = mVideoDuration * v;
                float right = mLocalThumbView.getRightInterval();
                mThumbSelTime = (int) ((right - left) * 30 / App.screenWidth);
                float width = mLocalThumbView.getTotalWidth();
                if (right == width) {
    ...
    private void initView() {
        ...
        mLocalThumbView.setMinInterval(App.screenWidth / 6);
    }
                        ...
                        localVideoActivity.mThumbAdapter.setLoadSuccessCallBack(new ThumbAdapter.LoadSuccessCallBack() {
                            ...
                            public void callback() {
                                ...
                                if (i < App.screenWidth) {
                                    if (i > App.screenWidth / 6) {
                                        localVideoActivity.mLocalThumbView.setWidth(i + DisplayUtil.dp2px(localVideoActivity,1));
                                    } else {
                                        localVideoActivity.mLocalThumbView.setWidth(App.screenWidth / 6 - DisplayUtil.dp2px(localVideoActivity,10));
                                    }
                                }
